    ...
    public partial class inmit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "К этой задаче нет подсказок", "В этой задаче тербуется найти сумму двух чисел", "[{\"input\":\"a = 1, b = 2\",\"output\":\"3\"},{\"input\":\"a = 3, b = 3\",\"output\":\"6\"}]", 1, "{\"Javascript\":\"JS Code Here!\",\"Csharp\":\"C# Code Here!\",\"CPlus\":\"C++ Code Here!\"}", "[{\"input\":{\"a\":1,\"b\":2},\"output\":{\"output\":3}},{\"input\":{\"a\":4,\"b\":4},\"output\":{\"output\":8}}]" });

            migrationBuilder.InsertData(
                table: "ProblemsDescription",
                columns: new[] { "ProblemId", "Cheat", "Description", "ExamplesJson", "Id", "InitialCodeJson", "TestCasesJson" },
                values: new object[] { 2, "К этой задаче нет подсказок", "В этой задаче тербуется найти разность двух чисел", "[{\"input\":\"a = 2, b = 1\",\"output\":\"1\"},{\"input\":\"a = 3, b = 3\",\"output\":\"0\"}]", 2, "{\"Javascript\":\"JS Code Here!\",\"Csharp\":\"C# Code Here!\",\"CPlus\":\"C++ Code Here!\"}", "[{\"input\":{\"a\":2,\"b\":1},\"output\":{\"output\":1}},{\"input\":{\"a\":4,\"b\":4},\"output\":{\"output\":0}}]" });
